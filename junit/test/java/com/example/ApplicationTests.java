...
//	        	.andExpect(jsonPath("$").value("true"))
    ...
    public void TestCase2() throws Exception {
	 	...
	 	String userOne = "{\"roomID\":\"011\",\"roomNo\":\"123\",\"adminID\":\"5678\",\"status\":\"available\",\"price\":\"5000\",\"type\":\"singlecot\"}";
	 	mockMvc.perform(MockMvcRequestBuilders.post("/admin/addRoom")
	 			.contentType(MediaType.APPLICATION_JSON)
	 			.content(userOne)
	 			.accept(MediaType.APPLICATION_JSON))
	        	.andExpect(status().isOk())
    ...
    public void TestCase4() throws Exception {
	 	...
	 	String userOne = "{\"hotelName\":\"Hotel1\",\"adminID\":\"admin@iamneo.ai\"}";
	 	mockMvc.perform(MockMvcRequestBuilders.post("/user/rooms")
	 			.contentType(MediaType.APPLICATION_JSON)
	 			.content(userOne)
	 			.accept(MediaType.APPLICATION_JSON))
	        	.andExpect(status().isOk())
